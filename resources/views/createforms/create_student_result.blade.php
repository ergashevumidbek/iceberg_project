...
<div class="container-fluid">
    <div class="page-title">
      <div class="row">
        <div class="col-sm-6">
          <h3>
             IceBerg Talabalarining Natijalari oynasi</h3>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
            <li class="breadcrumb-item">Bosh sahifa</li>
            <li class="breadcrumb-item active">Talaba Natija                           </li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="form theme-form">
              ...
              <div class="row">
                <div class="col">
                  <div class="text-end"><a class="btn btn-success me-3" href="javascript:void(0)">Saqlash</a><a class="btn btn-danger" href="{{route('student_result_table')}}">Bekor qilish</a></div>
                </div>
              </div>
            </div>
          </div>
