      ...
      <nav class="sidebar-main">
        ...
        <div id="sidebar-menu">
          <ul class="sidebar-links" id="simple-bar">
            ...
            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="{{route("students_table")}}"><i data-feather="users"></i><span>Talabalar </span></a></li>
            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="{{route("teachers_table")}}"><i data-feather="user"></i> </i><span>O'qituvchilar </span></a></li>
            ...
            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="{{route('subjects_table')}}"><i data-feather="book"></i><span>Fanlar va Etablar</span></a></li>
            ...
            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="{{route('student_result_table')}}"><i data-feather="monitor"> </i><span>Natijalar</span></a></li>
            ...
            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="{{route('billing_table')}}"><i data-feather="activity"></i><span>To'lovlar</span></a></li>
