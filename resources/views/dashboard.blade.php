          ...
          <div class="card-header pb-0">
            <div class="d-flex"> 
              <div class="flex-grow-1"> 
                <p class="square-after f-w-600 header-text-primary">Umumiy talabalar<i class="fa fa-circle"> </i></p>
                <h4>6659</h4>
              </div>
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card o-hidden product-widget">
          <div class="card-header pb-0">
            <div class="d-flex"> 
              <div class="flex-grow-1"> 
                <p class="square-after f-w-600 header-text-success">Etab va Fanlar<i class="fa fa-circle"> </i></p>
                <h4>9856</h4>
              </div>
              <div class="d-flex static-widget">
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card o-hidden message-widget">
          <div class="card-header pb-0">
            <div class="d-flex"> 
              <div class="flex-grow-1"> 
                <p class="square-after f-w-600 header-text-secondary">O'qituvchilar<i class="fa fa-circle"> </i></p>
                <h4>893</h4>
              </div>
              <div class="d-flex static-widget">
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card o-hidden user-widget">
          <div class="card-header pb-0">
            <div class="d-flex"> 
              <div class="flex-grow-1"> 
                <p class="square-after f-w-600 header-text-info">To'lovlar<i class="fa fa-circle"> </i></p>
                <h4>45631</h4>
              </div>
              <div class="d-flex static-widget">
              ...
              <div class="col-sm-6">
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    ...
                    <div class="flex-grow-1">
                      <h6>Bugun</h6>
                      <h5>$<span class="counter">5698</span><span class="font-primary ms-1">-36%($258)</span></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    ...
                    <div class="flex-grow-1">
                      <h6>Oylik</h6>
                      <h5>$<span class="counter">654</span><span class="font-secondary ms-1">-15%($369)                               </span></h5>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card-body">
            <div class="row gy-4">
              <div class="col-sm-6">
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    <div class="widget-icon bg-light-primary flex-shrink-0">
              ...
              <div class="col-sm-6">
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    <div class="widget-icon bg-light-warning flex-shrink-0">
                    ...
                    <div class="flex-grow-1">
                      <h6>Qabul qilinganlar</h6>
                      <h5>783<span class="font-roboto font-warning f-w-700"><i class="icofont icofont-arrow-down"></i> 12%</span></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    <div class="widget-icon bg-light-success flex-shrink-0">
                    ...
                    <div class="flex-grow-1">
                      <h6>Hozirgi davrda</h6>
                      <h5>$647<span class="font-roboto font-success f-w-700"><i class="icofont icofont-arrow-up"></i> 50%</span></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    <div class="widget-icon bg-light-danger flex-shrink-0">
